describe('color-contrast', function () {
	...
	it('should return undefined when there are elements overlapping', function () {
		fixture.innerHTML = '<div class="parent" style="color: black; background-color: white; width: 200px; height: 100px;" id="target">' +
			'My text <div class="child" style="position: absolute; top: 0; left: 0; background-color: white; width: 100%; height: 100%;"></div></div>';
		var target = fixture.querySelector('#target');
